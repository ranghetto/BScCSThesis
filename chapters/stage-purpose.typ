...
#v(1em)
#text(style: "italic", [
  In questo capitolo si andranno ad analizzare le problematiche che hanno messo le basi per la realizzazione della proposta di #emph[stage], assieme alla risposta formalizzata al fine di risolverle.
])
#v(1em)
