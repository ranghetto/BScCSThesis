...
#v(1em)
#text(style: "italic", [
  Nel presente capitolo si vuole descrivere il metodo di lavoro adottato durante lo svolgimento del tirocinio, quali sono stati i principali problemi affrontati e infine quali sono stati i frutti del lavoro svolto.
])
#v(1em)
...
=== Progettazione
Problemi affrontati durante la progettazione.
