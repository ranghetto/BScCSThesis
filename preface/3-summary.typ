...
Il #link(<cap:stage-purpose>)[secondo capitolo] descrive lo
scopo del tirocinio, i prodotti attesi, il metodo di lavoro e gli obiettivi personali.
Il #link(<cap:stage-description>)[terzo capitolo] descrive nel dettaglio il metodo di
tracciamento del lavoro e quali sono stati i problemi affrontati durante il
corso del tirocinio; alla fine del capitolo vengono presentati i risultati ottenuti e le conclusioni tratte.
Per finire il #link(<cap:conclusions>)[quarto capitolo]
